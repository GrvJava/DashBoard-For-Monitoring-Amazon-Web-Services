		          ...
		          rs = DBConnect.Aid_Search.executeQuery();
					...
					if(rs.next())
                        ...
                        session.setAttribute("oemail",rs.getString(3));
							 ...
							 %>
							 <form action='DUserServlet' method='post' onsubmit="return confirm('Are you sure?')">
						 <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                 <p><input style="background-color:lightgrey;height:30px;width:250px" type = "text" value = "<%= rs.getString(1) %>" name = "fname" disabled><br><span></span></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <p><input style="background-color:lightgrey;height:30px;width:250px" type = "text" value = "<%= rs.getString(9) %>" name = "lname" disabled><br><span></span></p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                 <p><input style="background-color:lightgrey;height:30px;width:250px" type = "text" value = "<%= rs.getString(10) %>" name = "akey" disabled><br><span></span></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                 <p><input style="background-color:lightgrey;height:30px;width:250px" type = "text" value = "<%= rs.getString(11) %>" name = "skey" disabled><br><span></span></p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <p><input style="background-color:lightgrey;height:30px;width:250px" type = "text" value = "<%= rs.getString(2) %>" name = "email" disabled><br><span></span></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <p><input style="background-color:lightgrey;height:30px;width:250px" type = "text" value = "<%= rs.getString(3) %>" name = "mob" disabled><br><span></span></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                               <p><input style="background-color:lightgrey;height:30px;width:250px" type = "text" value = "<%= rs.getString(5) %>" name = "country" disabled><br><span></span></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                              <p><input style="background-color:lightgrey;height:30px;width:250px" type = "text" value = "<%= rs.getString(8) %>" name = "city" disabled><br><span></span></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input style="background-color:lightgrey;height:30px" type='submit' value='Delete User' />
                            </td>
                        </tr>
